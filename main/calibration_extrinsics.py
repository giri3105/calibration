...
def main():
    ...
    parser.add_argument('--calibration', type=str, default='/home/giri/calibration/debug/calibration_results.yml',
    ...
    parser.add_argument('--patternCentric', action='store_false',
